...
namespace PetaPoco
{
    ...
    public class ColumnInfo
    {
        ...
        internal static void PopulateFromProperty(PropertyInfo pi, ref ColumnInfo ci, out ColumnAttribute columnAttr)
        {
            ...
            bool isExplicit = pi.DeclaringType.GetCustomAttributes(typeof(ExplicitColumnsAttribute), true).Any();
            ...
            bool isIgnore = pi.GetCustomAttributes(typeof(IgnoreAttribute), true).Any();
