...
namespace PetaPoco
{
    ...
    public class ConventionMapper : IMapper
    {
        ...
        public ConventionMapper()
        {
            ...
            MapPrimaryKey = (ti, t) =>
            {
                TableInfo.PopulatePrimaryKeyFromPoco(t, ref ti, out PrimaryKeyAttribute pkAttr, out PropertyInfo idProp);
            ...
            MapTable = (ti, t) =>
            {
                TableInfo.PopulateTableNameFromPoco(t, ref ti, out TableNameAttribute tblAttr);
                if (tblAttr == null)
            ...
            MapColumn = (ci, t, pi) =>
            {
                ColumnInfo.PopulateFromProperty(pi, ref ci, out ColumnAttribute columnAttr);
